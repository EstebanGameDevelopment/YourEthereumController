...
namespace YourEthereumController
{
	...
	public class EthereumExchangeHTTP : BaseDataHTTP, IHTTPComms
	{
		...
		public override void Response(string _response)
		{
			...
			EthereumEventController.Instance.DispatchEthereumEvent(EthereumController.EVENT_ETHEREUMCONTROLLER_EXCHANGE_DATA, m_jsonResponse);
		}
	}
}
